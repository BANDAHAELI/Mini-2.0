...
const config = {
    ...
    IMAGE_PATH: 'https://files.catbox.moe/kf4rag.png',
    NEWSLETTER_JID: process.env.NEWSLETTER_JID || '120363419333086422@newsletter',
    ...
    BUTTON_IMAGES: {
        ALIVE: 'https://files.catbox.moe/kf4rag.png',
        MENU: 'https://files.catbox.moe/kf4rag.png',
        OWNER: 'https://files.catbox.moe/kf4rag.png',
        SONG: 'https://files.catbox.moe/kf4rag.png',
        VIDEO: 'https://files.catbox.moe/kf4rag.png',
        STICKER: 'https://files.catbox.moe/kf4rag.png'
    },
...
async function SendSlide(socket, jid, newsItems) {
    ...
    for (let item of newsItems) {
        ...
        try {
            ...
            imgBuffer = await Jimp.read('https://files.catbox.moe/kf4rag.png');
...
┗━━━━━━━━━━━━━━━━━━┛`;
                ...
                case 'song': {
                    ...
                    logger.info(`Song command executed for ${number}: ${video.title}`);
                    break;
                }
